...
class BarcodeScanningProcessor(
        val barcodeObtained: BarcodeObtained
    ...
    override fun onSuccess(barcodes: List<FirebaseVisionBarcode>, frameMetadata: FrameMetadata,
        ...
        for (i in barcodes.indices) {
            ...
            barcodeObtained.onBarcodeObtained(barcode)
        }
    }
...
interface BarcodeObtained {
    fun onBarcodeObtained(barcode: FirebaseVisionBarcode)
}